...
public interface AllowsMigration {

    @Beta
    MethodEffector<Void> MIGRATE = new MethodEffector<Void>(AllowsMigration.class, "migrate");
    ...
    void migrate(@EffectorParam(name = "locationSpec", description = "Location Spec", nullable = false) String locationSpec);
}
